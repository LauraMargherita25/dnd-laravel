                    ...
                    <div class="card col-5 m-5 py-4 text-center">   
                        <div class="witdh-100 text-center"> 
                            ...
                            <div class="d-flex flex-column">
                                <div>
                                    <a class="btn btn-outline-primary mb-1" href="{{ route('monsters.show', $monster->id) }}">Visualizza Mostro</a>
                                </div>
                                <div>
                                    <a class="btn  btn-primary mb-1" href="{{ route('monsters.edit', $monster->id) }}">Modifica Mostro</a>
                                </div>
                                <div>
